export default function HomePage() {
  return (
    <div className="grid content-center items-center gap-y-6 md:gap-y-8">
      <h1 className="text-primary-foreground text-center text-2xl leading-tight font-medium text-balance uppercase md:text-left md:text-5xl">
        Seamlessly transfer assets between Starcoin and Ethereum
      </h1>
      <nav className="flex items-center justify-center gap-x-1 md:justify-start">
        <a
